...
[_QWERTY] = LAYOUT( \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC, KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT , \
                   KC_LGUI, KC_LALT, LOWER,  KC_SPC,  KC_ENT,  KC_SPC, KC_SPC, RAISE,    KC_RALT, KC_BSLASH \
),
...
[_RAISE] = LAYOUT( \
  ...
  KC_GRV,  KC_1,    KC_UP,   KC_3,    KC_4,    KC_5,                       KC_6,   KC_UP,    KC_8,    KC_9,    KC_0,    KC_BSPC, \
  KC_DEL,  KC_LEFT, KC_DOWN, KC_RGHT, KC_F4,   KC_F5,                   KC_LEFT, KC_RGHT,  KC_EQL, KC_LBRC, KC_RBRC,    KC_QUOT, \
  _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  _______, _______, KC_F12,  KC_DOWN, KC_MINS, _______, _______, _______, \
                    _______, _______, _______, _______, _______, _______,  _______, _______, _______, _______\
),
...
[_ADJUST] =  LAYOUT( \
  ...
  QWERTY,  COLEMAK, DVORAK,  _______, _______, _______, _______, _______, RGB_M_B, RGB_M_R, RGB_M_SW, RGB_M_SN, RGB_M_K, RGB_M_X, \
                    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______\
)
